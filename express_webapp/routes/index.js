...
router.post('/', function(req, res, next) {
  ...
  */
  if(role == 'undefined' || role == null){
    messageError = 'Vous n avez pas accès à se service , merci de vous connecter avant';
                    ...
                    if (err ) {
                      ...
                      if(eleve_req.length != 0){
                        ...
                        for(var i = 0; i < eleve_req.length; i++){
                          ...
                          if((prenomEleveBdd.localeCompare(prenomEleve)) == 0 && (nomEleveBdd.localeCompare(nomEleve)) ==0 && (classeEleveBdd.localeCompare(classeEleve)) == 0){
                            existant = true;
